  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <ComingSoonModal
        ...
        title="Order Now Coming Soon!"
        description="We're putting the finishing touches on our ordering system. Get ready to enjoy Lagos' finest cuisine delivered to your doorstep!"
      />
