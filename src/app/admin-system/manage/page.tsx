...
export default function AdminManagement() {
  const { adminUser, isAdminAuthenticated, isSuperAdminRole, isAdminLoading } = useAuth()
  ...
  useEffect(() => {
    ...
    if (!isSuperAdminRole && !adminUser?.permissions?.admins?.create) {
      router.push('/admin-system/dashboard')
      return
    }

    loadAdmins()
  }, [isAdminAuthenticated, adminUser, isSuperAdminRole, isAdminLoading, router])
  ...
  return (
    <ErrorBoundary showDetails={true}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {isSuperAdminRole && admin.role !== 'super_admin' && (
                      <button
        ...
        {/* Admin Details Modal - We'll add this next */}
        {selectedAdmin && (
          <AdminDetailsModal
            admin={selectedAdmin}
...
// Admin Details Modal Component (placeholder - we'll implement this next)
